...
<!-- /.content-wrapper -->
   ...
   <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2018 <a href="https://corporate-office-29940.business.site/?m=true" target="_blank">www.jalalalbadit.com</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="admin-theme/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
 ...
 <!-- DataTables -->
 <script src="admin-theme/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
 <script src="admin-theme/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
...
<!-- ChartJS -->
<script src="admin-theme/bower_components/chart.js/Chart.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="admin-theme/dist/js/pages/dashboard2.js"></script>
