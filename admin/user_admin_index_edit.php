...
<div class="row">
	<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
		<nav class="navbar nav-pills nav-stacked;" id="navbar">
		    <div class="container-fluid " id="navbar">
				<div class="btn-group btn-group-justified" class="col-md-8 col-md-offset-2">
					<ul class="nav nav-pills nav-stacked">
				
					  <li class="active" style="margin-left:0px; text-align:center;"><a href="user_index_view.php?user_id=<?php echo $row['user_id']; ?>">Back Admin HomePage</a></li>
