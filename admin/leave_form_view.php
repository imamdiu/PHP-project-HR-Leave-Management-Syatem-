    ...
    <div class="row">
        ...
        <div class=" col-md-6 col-md-offset-4 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
			...
			?>
                ...
                <td>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal<?php echo $r['id']; ?>">Delete Application</button>
                    <!--Modal -->
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="leave_form_delete.php?id=<?php echo $r['id']; ?>"><button type="button"
                                            target="" class="btn btn-danger"> Yes..! Delete</button></a>
                                </div>
                            </div>
			...
			?>
                ...
                <td>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal<?php echo $r['user_id']; ?>">Reject
                        Application</button>
                    <!--Modal -->
                    <div class="modal fade" id="myModal<?php echo $r['user_id']; ?>" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                    <a href="leave_form_reject_admin.php?user_id=<?php echo $r['user_id']; ?>"><button
                                            type="button" target="" class="btn btn-danger"> Yes..! Delete</button></a>
                                </div>
                            </div>

                        </div>
                    </div>
                    <!-- <a href="leave_form_reject_admin.php?user_id=<?php echo $rd['user_id']; ?>" target=""><button
