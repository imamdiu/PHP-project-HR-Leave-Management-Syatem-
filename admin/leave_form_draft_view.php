            ...
            <tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="leave_accept.php?user_id=<?php echo $r['user_id']; ?>" target=""><button type="button"  id="print" class="btn btn-success">Accept Application</button></a>
					</td>	
					<td>
					<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal<?php echo $r['id']; ?>">Reject Application</button>
								<!--Modal -->
									...
									<div class="modal-dialog">
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a href="leave_form_reject_admin.php?user_id=<?php echo $r['user_id']; ?>"><button type="button" target="" class="btn btn-danger"> Yes..! Delete</button></a>
											</div>
										</div>
					...
					<td>				
						<a href="leave_form_view_admin.php?user_id=<?php echo $r['user_id']; ?>" target=""><button type="button"  class="btn btn-info">Leave Form View (AD)</button></a>
					</td>
					<td>				
