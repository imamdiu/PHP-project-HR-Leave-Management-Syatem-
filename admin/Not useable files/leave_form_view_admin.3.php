            ...
            <div class="box box-primary">
                ...
                <form class="form-horizontal" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <td>
                            <button type="button" id="print" onclick="printPage()" class="btn btn-info">Print This
                                Application</button>
                        </td>
                        <?php 
						...
						?>
                        <td>
                            <a href="leave_form_edit.php?user_id=<?php echo $rd['user_id']; ?>" target="_blank"><button
                                    type="button" id="print" class="btn btn-primary">Edit Application</button></a>
                        </td>
                        <td>
                            <a href="leave_form_delete.php?user_id=<?php echo $rd['user_id']; ?>" target="_blank"><button
                                    type="button" id="print" class="btn btn-danger">Delete Application</button></a>
                        </td>
						...
						?>
                        <td>
                            <a href="leave_accept.php?user_id=<?php echo $rd['user_id']; ?>" target="_blank"><button
                                    type="button" id="print" class="btn btn-success">Accept Application</button></a>
                        </td>
                        <td>
                            <a href="leave_form_reject_admin.php?user_id=<?php echo $rd['user_id']; ?>" target="_blank"><button
                                    type="button" id="print" class="btn btn-danger">Reject Application</button></a>
                        </td>
                        <?php } ?>
                    </div>
