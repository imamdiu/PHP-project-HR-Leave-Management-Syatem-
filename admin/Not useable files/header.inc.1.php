    ...
    <div class="wrapper ">
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
				...
				?>
                                <img src="<?php echo $upload_dir.$row['image'] ?>" class="user-image" alt="Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <img src="<?php echo $upload_dir.$row['image'] ?>" class="img-circle" alt="User Image">
...
?>
                    <li class="active menu-open">
                        <a href="user_index_view.php">
                            <i class="fa fa-dashboard"></i> <span>Only for Admin</span>
                        </a>
                    </li>
