...
<div class="form-group">
    <label for="degree_title" class="col-sm-4 control-label"> <strong>Religion </strong></label>
    <div class="col-sm-7">
        ...
        <option value="H.S.C" <?php if($r['degree_title']=='hsc' ){ echo "selected" ;} ?>
            >H.S.C</option>
        <option value="Diploma " <?php if($r['degree_title']=='diploma ' ){ echo "selected" ;} ?> > Diploma </option>
        <option value="Bachelor/ Honors " <?php if($r['degree_title']=='bachelor' ){ echo "selected" ;} ?>> Bachelor/
            Honors </option>
        <option value="Masters  " <?php if($r['degree_title']=='masters ' ){ echo "selected" ;} ?>> Masters </option>
        <option value="Bachelor/ Honors " <?php if($r['degree_title']=='bachelor' ){ echo "selected" ;} ?>> Bachelor/
            Honors </option>
        </select>
    </div>
...
<OPTION VALUE="South African" <?php if($r['nationality']=='South African' ){ echo "selected" ;} ?> >South African
</OPTION>
...
$DelSql = "DELETE FROM `updatee_educational_info` WHERE user_id=$user_id AND degree_title=$degree_title";
$res = mysqli_query($conn, $DelSql);

if($res){
//header('location: personal_info_edit.php');
echo '<script>
    window.location = "educational_info_edit.php"
</script>';
}else{
...
$query=mysql_query("SELECT * from updatee_educational_info where user_id='$user_id'");
...
echo "User Degree Title :: "." ".$degree_title;