...
<section class="content">
    <div class="row">
        ...
        <div class=" col-md-6 col-md-offset-4 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
			...
			?>
                    <td>
                        <a href="leave_accept.php?user_id=<?php echo $rd['user_id']; ?>" target="_blank"><button type="button"
                                id="print" class="btn btn-success">Accept Application</button></a>
                    </td>
                    <td>
                        <a href="leave_reject.php?user_id=<?php echo $rd['user_id']; ?>" target="_blank"><button type="button"
